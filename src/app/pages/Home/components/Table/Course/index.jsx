...
const CourseTable = () => {
    ...
    const handleDelete = async (id) => {
        try {
            if (
                window.confirm('Bạn có chắc chắn muốn xóa khóa học này không?')
            ) {
    ...
    return (
        <div className='relative overflow-x-auto'>
            <div className='text-right'>
                <Link
                    to='/courses/create'
                    className='text-sm font-medium uppercase text-blue-600 hover:underline underline-offset-4 select-none outline-none'
                >
                    Thêm khóa học
                </Link>
            </div>
